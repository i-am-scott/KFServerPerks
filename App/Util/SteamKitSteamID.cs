...
{
    /*
     * https://github.com/SteamRE/SteamKit/tree/9d425330c8dbd581bce96827f14672ca09e619a9
     * https://github.com/SteamRE/SteamKit/blob/9d425330c8dbd581bce96827f14672ca09e619a9/LICENSE
    ...
    namespace SteamKit2
    {
        ...
        class SteamKitSteamID
        {
            public ulong Data { get; set; }

            public SteamKitSteamID(ulong value)
            {
                Data = value;
            }
        ...
        {
            readonly SteamKitSteamID steamid;
            ...
            static readonly Dictionary<EAccountType, char> AccountTypeChars = new Dictionary<EAccountType, char>
        {
            ...
            public SteamID(ulong id) => this.steamid = new SteamKitSteamID(id);
